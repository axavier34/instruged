...
@section('content')
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{route('departamento.store')}}" method="post">
                @csrf
                <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Descrição</label>
                    <div class="col-sm-10">
                         <input type="text" name="departamento" value="{{old('departamento')}}"class="form-control @error('departamento') is-invalid @enderror" id="inputEmail3" placeholder="Nome Completo">
                    </div>
                </div>
